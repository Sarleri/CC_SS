...
public partial class LSS : System.Web.UI.Page
{
    ...
    protected void GetruntimestatLSS(){
     ...
     protected void getpendingreportLSS(){
         string url = "http://192.168.22.40/x/bAMSBg";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgRTLSS.Visible = true;
                imgRTLSS.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgPCLSS.Visible = true;
                imgPCLSS.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
