...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <h1 style="text-align:inherit;  text-shadow:2px 2px 4px #C0C0C0; color: #0000FF; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-style: italic; font-size:large; font-weight: 900; border-right-color: #C0C0C0;">Historic Chart Generator: coming soon...</h1> 
    ...
    <asp:TextBox ID="From_Date" runat="server" Visible="false"></asp:TextBox>
...
<h1 style="text-align:inherit;  text-shadow:2px 2px 4px #C0C0C0; color: #0000FF; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-style: italic; font-size:medium; font-weight: 900; border-right-color: #C0C0C0;">To Date:</h1>    
    ...
    <asp:TextBox ID="To_Date" runat="server" Visible="false" ></asp:TextBox>
    ...
    <asp:Button ID="Button1" runat="server" Text="Generate" Enabled="false" OnClick="Button1_Click"/>
