...
public partial class Spartan : System.Web.UI.Page
{  
    protected void Page_Load(object sender, EventArgs e)
    {
        GetruntimestatSpartan();
        getpendingreportSpartan();
    }
    protected void GetruntimestatSpartan(){
     ...
     protected void getpendingreportSpartan(){
         string url = "http://192.168.22.40/x/xgMSBg";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgRTSpartan.Visible = true;
                imgRTSpartan.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgPCSpartan.Visible = true;
                imgPCSpartan.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
