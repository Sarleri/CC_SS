...
public partial class Sobeys : System.Web.UI.Page
{  
    protected void Page_Load(object sender, EventArgs e)
    {
      //  GetruntimestatSobeys();
      //  getpendingreportSobeys();
    }
    protected void GetruntimestatSobeys(){
     ...
     protected void getpendingreportSobeys(){
         string url = "http://192.168.22.40/x/vQMSBg";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
              ...
              //  imgRTSobeys.Visible = true;
             //   imgRTSobeys.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                //imgPCSobeys.Visible = true;
               // imgPCSobeys.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
