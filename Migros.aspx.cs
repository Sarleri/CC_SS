...
public partial class Migros : System.Web.UI.Page
{
 
   
    protected void Page_Load(object sender, EventArgs e)
    {
        GetruntimestatMigros();
        getpendingreportMigros();
    }
    protected void GetruntimestatMigros(){
     ...
     protected void getpendingreportMigros(){
         string url = "http://192.168.22.40/x/sQMSBg";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgRTMigros.Visible = true;
                imgRTMigros.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgPCMigros.Visible = true;
                imgPCMigros.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
