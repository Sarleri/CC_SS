...
public partial class Test : System.Web.UI.Page
{
    ...
    public DataSet CsvToDataTable(int id)
    {
        ...
        string[] file = new string[12]{ "sains01Ramusage.csv", "ssl03Ramusage.csv", "ssl04Ramusage.csv", 
            "cvs01Ramusage.csv", "cvs02Ramusage.csv", "sobeysT1Ramusage.csv", "madisont1Ramusage.csv", "spartant1Ramusage.csv",
            "migrosT1Ramusage.csv","sonaet1Ramusage.csv", "aeont1Ramusage.csv" ,"icat1Ramusage.csv"};
    ...
    public void getcharts()
    {
        ...
        Chart1.Series["Series0"].Points.DataBindXY(dataset.Tables[0].DefaultView, "UK_TIMESTAMP", dataset.Tables[0].DefaultView, "PERCENT_USED");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        dir1 = ConfigurationManager.AppSettings["Systemcharts"];
        ...
        string[] file1 = new string[12]{ "sains01Ramusagehistory.csv", "ssl03Ramusagehistory.csv", "ssl04Ramusagehistory.csv", 
            "cvs01Ramusagehistory.csv", "cvs02Ramusagehistory.csv", "sobeys01Ramusagehistory.csv", "madison1Ramusagehistory.csv", "spartan01Ramusagehistory.csv", 
            "migrost1Ramusagehistory.csv","sonaet1Ramusagehistory.csv", "aeont1RamusageHistory.csv" ,"ica1Ramusagehistory.csv"};
