...
public partial class Madison : System.Web.UI.Page
{
    
    protected void Page_Load(object sender, EventArgs e)
    {
        GetruntimestatMadison();
        getpendingreportMadison();
    }
    protected void GetruntimestatMadison(){
     ...
     protected void getpendingreportMadison(){
         string url = "http://192.168.22.40/x/qQMSBg ";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgRTMadison.Visible = true;
                imgRTMadison.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgPCMadison.Visible = true;
                imgPCMadison.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
