...
public partial class CVS : System.Web.UI.Page
{
    ...
    protected void GetruntimestatCVS(){
     ...
     protected void getpendingreportCVS(){
         string url = "http://192.168.22.40/x/oAMSBg";
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                //imgRTCVS.Visible = true;
                //imgRTCVS.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                //imgPCCVS.Visible = true;
              //  imgPCCVS.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
